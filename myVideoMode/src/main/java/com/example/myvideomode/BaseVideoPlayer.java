...
public class BaseVideoPlayer extends FragmentActivity implements IStartService,PlayVideoProxy,MediaPlayer.OnPreparedListener, MediaPlayer.OnInfoListener, MediaPlayer.OnBufferingUpdateListener, OnClickListener, OnCompletionListener, OnSeekCompleteListener {
...
//			if (mUpdateRatio > mCurrentRatio) {
//				submitVideoRatio(mId, mUpdateRatio);
//			}
		}
		mVideoView.pause();
	}
...
//			restoreVideo();
	...
	private void setPlayScreenSize(int width, int height) {
		...
		RelativeLayout.LayoutParams headerParams = (LayoutParams) mMediaScreenWrapper.getLayoutParams();
...
//		playVideo(1);
	...
	public void iPlayVideo(Bundle bundle) {
		...
		playVideo(bundle.getString("title"), bundle.getString("url")
				,"aaa",false,false	);
